...
$PATH_TO_IMAGES = version_compare(VERSION, 4, '<')
    ? 'view/image/payment/apirone/'
    : '../extension/apirone/admin/view/image/payment/';
...
$_['error_cant_get_currencies'] = 'Can\'t get list of currencies. %s';
$_['error_cant_get_currencies_service_unavailable'] = 'Can\'t get list of currencies. Service unavailable. Please, try later.';
