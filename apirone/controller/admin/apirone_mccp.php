...
class ControllerExtensionPaymentApironeMccpAdmin extends \Apirone\Payment\Controller\ControllerExtensionPaymentApironeMccpCommon
{
    ...
    protected function setTestTemplateData(): void
    {
        $this->data = (array) \json_decode('{
            "apirone_mccp_account": "apr-601fa463c18519629ccd9139ecdf7968",
            "settings_loaded": true,
            "apirone_mccp_merchant": "",
            "apirone_mccp_testcustomer": "*",
            "apirone_mccp_timeout": "180",
            "apirone_mccp_processing_fee": "percentage",
            "apirone_mccp_with_fee": "1",
            "apirone_mccp_factor": "1",
            "apirone_mccp_logo": "",
            "apirone_mccp_debug": "",
            "apirone_mccp_status": "1",
            ...
            "networks": {
                "btc": {
                    ...
                    "name": "Bitcoin",
                    "address": null,
                    "tooltip": "Enter valid address to activate Bitcoin<\/b> currency",
                    "testnet": false,
                    "error": null
                },
                "tbtc": {
                    ...
                    "address": "2N186GvYp1gctUXMT4RXzAv3N5MB7wLncq7",
                    "tooltip": "Remove address to deactivate Bitcoin (testnet)<\/b> currency",
                    "testnet": true,
                    "error": null,
                    "test_tooltip": "Use this currency for testing purposes only! It is displayed on the front end for `Test currency customer`."
                },
                "ltc": {
                    "icon": "ltc",
                    "name": "Litecoin",
                    "address": null,
                    "tooltip": "Enter valid address to activate Litecoin<\/b> currency",
                    "testnet": false,
                    "error": null
                },
                "bch": {
                    ...
                    "name": "Bitcoin Cash",
                    "address": null,
                    "tooltip": "Enter valid address to activate Bitcoin Cash<\/b> currency",
                    "testnet": false,
                    "error": null
                },
                "doge": {
                    ...
                    "name": "Dogecoin",
                    "address": null,
                    "tooltip": "Enter valid address to activate Dogecoin<\/b> currency",
                    "testnet": false,
                    "error": null
                },
                "trx": {
                    ...
                    "address": null,
                    "tooltip": "Enter valid address to activate TRON<\/b> currency",
                    "testnet": false,
                    "error": null,
                    "tokens": {
                        "trx": {
                            "checkbox_id": "state_trx",
                            "icon": "trx",
                            "name": "TRON",
                            "state": false,
                            "tooltip": "Show\/hide TRON<\/b> from currency selector"
                        },
                        "usdt@trx": {
                            "checkbox_id": "state_trx_usdt",
                            "icon": "usdt",
                            "name": "USDT (TRC20)",
                            "state": false,
                            "tooltip": "Show\/hide USDT (TRC20)<\/b> from currency selector"
                        },
                        "usdc@trx": {
                            "checkbox_id": "state_trx_usdc",
                            "icon": "usdc",
                            "name": "USDC (TRC20)",
                            "state": false,
                            "tooltip": "Show\/hide USDC (TRC20)<\/b> from currency selector"
                        }
                    }
                },
                "eth": {
                    ...
                    "address": null,
                    "tooltip": "Enter valid address to activate Ethereum<\/b> currency",
                    "testnet": false,
                    "error": null,
                    "tokens": {
                        "eth": {
                            "checkbox_id": "state_eth",
                            "icon": "eth",
                            "name": "ETHEREUM",
                            "state": false,
                            "tooltip": "Show\/hide ETHEREUM<\/b> from currency selector"
                        },
                        "usdt@eth": {
                            "checkbox_id": "state_eth_usdt",
                            "icon": "usdt",
                            "name": "USDT (ERC20)",
                            "state": false,
                            "tooltip": "Show\/hide USDT (ERC20)<\/b> from currency selector"
                        },
                        "usdc@eth": {
                            "checkbox_id": "state_eth_usdc",
                            "icon": "usdc",
                            "name": "USDC (ERC20)",
                            "state": false,
                            "tooltip": "Show\/hide USDC (ERC20)<\/b> from currency selector"
                        }
                    }
                },
                "bnb": {
                    "icon": "bnb",
                    "name": "BNB Smart Chain Blockchain",
                    "address": null,
                    "tooltip": "Enter valid address to activate BNB Smart Chain<\/b> currency",
                    "testnet": false,
                    "error": null,
                    "tokens": {
                        "bnb": {
                            "checkbox_id": "state_bnb",
                            "icon": "bnb",
                            "name": "BNB SMART CHAIN",
                            "state": false,
                            "tooltip": "Show\/hide BNB SMART CHAIN<\/b> from currency selector"
                        },
                        "usdt@bnb": {
                            "checkbox_id": "state_bnb_usdt",
                            "icon": "usdt",
                            "name": "USDT (BEP20)",
                            "state": false,
                            "tooltip": "Show\/hide USDT (BEP20)<\/b> from currency selector"
                        },
                        "usdc@bnb": {
                            "checkbox_id": "state_bnb_usdc",
                            "icon": "usdc",
                            "name": "USDC (BEP20)",
                            "state": false,
                            "tooltip": "Show\/hide USDC (BEP20)<\/b> from currency selector"
                        }
                    }
                }
            },
            "apirone_mccp_invoice_status_ids": {
                "created": 1,
                "partpaid": 1,
                "paid": 5,
                "overpaid": 5,
        ...
        $this->data['networks'] = (array) $this->data['networks'];
        foreach ($this->data['networks'] as $network) {
            if (\property_exists($network, 'tokens')) {
                $network->tokens = (array) $network->tokens;
            }
        }
        $this->data['apirone_mccp_invoice_status_ids'] = (array) $this->data['apirone_mccp_invoice_status_ids'];
        $this->data['apirone_status_labels'] = (array) $this->data['apirone_status_labels'];
    }
}
